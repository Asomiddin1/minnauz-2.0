...
export class AuthController {
  ...
  @ApiResponse({ status: 200, description: 'Tasdiqlash kodi muvaffaqiyatli yuborildi' })
  ...
  @Post('otp/verify')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'OTP kodni tekshirish va tizimga kirish/roʻyxatdan oʻtish' })
  @ApiResponse({ status: 200, description: 'Muvaffaqiyatli kirildi va tokenlar qaytarildi' })
  ...
  @ApiResponse({ status: 200, description: 'Google orqali muvaffaqiyatli kirildi' })
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Foydalanuvchining faol qurilmalari roʻyxati (Maksimal 3 ta)' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Admin huquqini tekshirish (Faqat Admin / SuperAdmin uchun)' })
